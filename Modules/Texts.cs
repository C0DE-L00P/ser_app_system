    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Ser_App Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Ser_App Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Ser_App";
        }
